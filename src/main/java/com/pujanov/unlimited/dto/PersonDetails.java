...
public class PersonDetails {
	...
	public String toString() {
		return "PersonDetails [eventName=" + eventName + ", scannedDate=" + scannedDate + ", scannedTime=" + scannedTime
				...
				+ ", countryId=" + countryId + ", phoneNumber=" + phoneNumber + ", phone2=" + phone2 + ", faxNumber="
				+ faxNumber + ", question=" + question + ", response=" + response + ", note=" + note + ", collateral="
				+ collateral + ", qualifiedDisqualified=" + qualifiedDisqualified + ", scannedBy=" + scannedBy + "]";
	}
